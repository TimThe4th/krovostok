...
/datum/map/mjolnir/get_network_access(var/network)
	switch(network)
		if(NETWORK_AQUILA)
...
// Substation SMES
/obj/machinery/power/smes/buildable/preset/mjolnir/substation
...
/obj/machinery/power/smes/buildable/preset/mjolnir/substation_full
...
/obj/machinery/power/smes/buildable/preset/mjolnir/engine_main
...
// Shuttle SMES
/obj/machinery/power/smes/buildable/preset/mjolnir/shuttle
	uncreated_component_parts = list(
...
/obj/machinery/power/smes/buildable/preset/mjolnir/hangar
	uncreated_component_parts = list(
		/obj/item/stock_parts/smes_coil/super_io = 2)
	_input_maxed = TRUE
	_output_maxed = TRUE
...
/datum/map/mjolnir/default_internal_channels()
	return list(
